...
*****************************************************************************************************************************************************/        
    ...
    if (myName == "Aaron Rainbird" || myName == "Amy Drewitt" || myName == "Tom Lowther" || myName == "John Zampetti" || myName == "Tom Bradfield" || myName == "Gareth Durant" || myName == "Faye Sampson" || myName == "Constantin Cerdan" || myName == "Lewis Clark" || myName == "Jonathan Pearson") {
