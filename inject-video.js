    ...
    if (arPIDs.length > 0) {
        ...
        if (subSite != "fulcrum") {
            if (site != "NAP" && site != "MrP") {
                ...
                userDefinedPIDs = userDefinedPIDs.replace(/_detail.mp4/gi, "")
                userDefinedPIDs = userDefinedPIDs.replace(/_detail.mov/gi, "")
                userDefinedPIDs = userDefinedPIDs.replace(/.mp4/gi, "")
                userDefinedPIDs = userDefinedPIDs.replace(/.mov/gi, "")
